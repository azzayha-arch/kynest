...
<div class="navbar">
    ...
    <div class="menu">
        ...
        <a href="tagihan.php" class="<?= ($current_page=='tagihan.php') ? 'active' : '' ?>">Tagihan</a>

        <a href="riwayat.php" class="<?= ($current_page=='riwayat.php') ? 'active' : '' ?>">Riwayat</a>

        <a href="notifikasi.php" class="<?= ($current_page=='notifikasi.php') ? 'active' : '' ?>">Notifikasi</a>

        <a href="akun.php" class="<?= ($current_page=='akun.php') ? 'active' : '' ?>">Akun</a>
    </div>
</div>
